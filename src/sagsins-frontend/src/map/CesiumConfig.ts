...
export const DEFAULT_CAMERA_VIEW = {
    // Vị trí nhìn xuống toàn cầu
    longitude: -95.0,
    latitude: 40.0,
    height: 10000000.0, // Đơn vị: mét
};
...
export const flyToLocation = (
    ...
    viewer.camera.flyTo({
        ...
        orientation: { 
            // Sử dụng các thuộc tính góc Euler để định nghĩa góc nhìn cuối cùng.
            // Ví dụ: Nhìn thẳng xuống (pitch = -90 độ)
            heading: 0, 
