...
import com.sagin.model.Position;
...
public class GeoUtils {
    ...
    public static boolean checkVisibility(NodeInfo sourceNode, NodeInfo destNode) {
        ...
        Position srcPos = sourceNode.getPosition();
        Position dstPos = destNode.getPosition();
    ...
    public static double calculateDistance3D(Position posA, Position posB) {
     ...
     */
    public static boolean checkVisibility(Position posA, Position posB) {
