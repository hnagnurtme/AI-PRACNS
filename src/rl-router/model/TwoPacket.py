...
class TwoPacket:
    ...
    def __init__(self, pairId: str = None, dijkstraPacket: Packet = None,
        ...
        self.pairId = pairId
        self.dijkstraPacket = dijkstraPacket
        self.rlPacket = rlPacket
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        result = {
            "_id": self.id,
            "pairId": self.pairId,
            "dijkstraPacket": self.dijkstraPacket.to_dict() if self.dijkstraPacket else None,
            "rlPacket": self.rlPacket.to_dict() if self.rlPacket else None
        }
        return result
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'TwoPacket':
        ...
        dijkstra_packet = None
        if dijkstra_data:
            dijkstra_packet = Packet.from_dict(dijkstra_data)

        rl_packet = None
        if rl_data:
            rl_packet = Packet.from_dict(rl_data)
