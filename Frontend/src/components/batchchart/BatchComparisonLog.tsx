                        ...
                        { filteredAndSorted.map( ( metrics ) => {
                            ...
                            return (
                                <tr
                                    ...
                                    className={ `hover:bg-gray-50 transition-colors ${ hasDropped ? 'bg-red-50' : ''
                                        }` }
                                >
                                    ...
                                    <td className={ `px-2 py-3 whitespace-nowrap text-xs font-semibold text-center ${ metrics.dijkstra.success ? 'text-green-600' : 'text-red-600'
                                        } bg-blue-50` }>
                                        { metrics.dijkstra.successRate.toFixed( 1 ) }%
                                        { metrics.dijkstra.dropped && <span className="block text-red-600 text-xs">❌</span> }
                                    </td>
                                    <td className={ `px-2 py-3 whitespace-nowrap text-xs font-semibold text-center ${ metrics.rl.success ? 'text-green-600' : 'text-red-600'
                                        } bg-orange-50` }>
                                    ...
                                    <td className="px-2 py-3 whitespace-nowrap text-xs text-center text-gray-700 bg-green-50">
                                    ...
                                    <td className="px-2 py-3 whitespace-nowrap text-xs text-center text-gray-700 bg-purple-50">
                                    ...
                                    <td className="px-2 py-3 whitespace-nowrap text-xs font-semibold text-center text-gray-700 bg-orange-50">
                                        { metrics.dijkstra.hops }
                                    </td>
                                    <td className="px-2 py-3 whitespace-nowrap text-xs font-semibold text-center text-gray-700 bg-orange-50">
                                        { metrics.rl.hops }
                                    </td>
                                    <td className="px-2 py-3 whitespace-nowrap text-xs text-center text-gray-700 bg-red-50">
                                    ...
                                    <td className="px-2 py-3 whitespace-nowrap text-xs text-center text-gray-700 bg-indigo-50">
                                    ...
                                    <td className="px-2 py-3 whitespace-nowrap text-xs text-center text-gray-700 bg-pink-50">
                                    ...
                                    <td className="px-2 py-3 whitespace-nowrap text-xs text-center text-gray-700 bg-yellow-50">
