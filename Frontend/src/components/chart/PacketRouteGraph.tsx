...
export const PacketRouteGraph: React.FC<Props> = ({ data }) => {
    ...
    return (
        <div className="p-6 bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-lg col-span-3 border border-gray-200">
            ...
            {/* 2-COLUMN GRID: Visualization (Left) | Information (Right) */}
            <div className="grid grid-cols-2 gap-4">
                ...
                {/* RIGHT COLUMN: Compact Metrics Panel */}
                <div className="space-y-3">
                    ...
                    <div className="bg-white rounded-lg border border-gray-300 overflow-hidden">
                        ...
                        <div className="divide-y divide-gray-200">
                                ...
                                <div className="p-3 hover:bg-blue-50 transition-colors">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-xs">
                                        <div>
                                            ...
                                            <p className={`font-bold ${data.dijkstraPacket.dropped ? 'text-red-600' : 'text-blue-600'}`}>
                                    ...
                                    <div className="mt-2 pt-2 border-t border-blue-200">
                                        ...
                                        <p className="text-xs text-blue-700 font-mono font-semibold break-all leading-relaxed">
                                            {data.dijkstraPacket.stationSource} → {data.dijkstraPacket.pathHistory.join(' → ')} → {data.dijkstraPacket.stationDest}
                                        </p>
                                    </div>
                                </div>
                            )}
                            ...
                            {/* RL Row */}
                            {data.rlPacket && (
                                <div className="p-3 hover:bg-orange-50 transition-colors">
                                    <div className="flex items-center justify-between mb-2">
                                        <span className="text-xs font-bold text-orange-700 uppercase tracking-wide">🟠 RL</span>
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-xs">
                                        <div>
                                            <p className="text-gray-500 font-medium">Latency</p>
                                            <p className={`font-bold ${data.rlPacket.dropped ? 'text-red-600' : 'text-orange-600'}`}>
                                    ...
                                    <div className="mt-2 pt-2 border-t border-orange-200">
                                        <p className="text-xs text-gray-500 font-medium mb-1">Path:</p>
                                        <p className="text-xs text-orange-700 font-mono font-semibold break-all leading-relaxed">
                                            {data.rlPacket.stationSource} → {data.rlPacket.pathHistory.join(' → ')} → {data.rlPacket.stationDest}
                                        </p>
                                    </div>
                                </div>
                            )}
