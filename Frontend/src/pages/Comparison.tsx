                ...
                <form onSubmit={handleCompare} className="space-y-4">
                    ...
                    <div className="bg-white/80 backdrop-blur-sm rounded-lg p-4 border border-violet-200">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-xs font-bold text-violet-700 mb-2 uppercase tracking-wide flex items-center gap-1">
                                    <span>📡</span>
                    ...
                    <div className="bg-white/80 backdrop-blur-sm rounded-lg p-4 border border-violet-200">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                <label className="block text-xs font-bold text-blue-600 mb-2 uppercase tracking-wide flex items-center gap-1">
                                    <span>🔵</span>
                                ...
                                <select
                                    ...
                                    className="block w-full px-3 py-2.5 border-2 border-blue-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-gray-800 font-medium transition-all"
                                    disabled={loading}
                                    required
                                >
                            ...
                            <div>
                                <label className="block text-xs font-bold text-orange-600 mb-2 uppercase tracking-wide flex items-center gap-1">
                                    <span>🟠</span>
                                ...
                                <select
                                    ...
                                    className="block w-full px-3 py-2.5 border-2 border-orange-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent bg-white text-gray-800 font-medium transition-all"
                                    disabled={loading}
                                    required
                                >
                                    <option value="simple">Simple</option>
                    ...
                    <div className="bg-white/80 backdrop-blur-sm rounded-lg p-4 border border-violet-200">
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <h3 className="text-xs font-bold text-violet-700 uppercase tracking-wide">Quality of Service Parameters</h3>
                        </div>
                ...
                <>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                        ...
                        <div className="bg-red-50 rounded-lg shadow-md p-3 border border-red-300">
                            ...
                            <div className="text-xl font-bold text-red-800">{statistics.critical}</div>
                        </div>
                        <div className="bg-yellow-50 rounded-lg shadow-md p-3 border border-yellow-300">
                            <div className="text-xs text-yellow-700 mb-1 font-medium uppercase tracking-wide">Warning</div>
                            <div className="text-xl font-bold text-yellow-800">{statistics.warning}</div>
                        </div>
                        <div className="bg-orange-50 rounded-lg shadow-md p-3 border border-orange-300">
                            <div className="text-xs text-orange-700 mb-1 font-medium uppercase tracking-wide">Overloaded</div>
                            <div className="text-xl font-bold text-orange-800">{statistics.overloaded}</div>
                        </div>
                        <div className="bg-pink-50 rounded-lg shadow-md p-3 border border-pink-300">
                            <div className="text-xs text-pink-700 mb-1 font-medium uppercase tracking-wide">Packet Loss</div>
                            <div className="text-xl font-bold text-pink-800">{statistics.highPacketLoss}</div>
                        </div>
                    </div>
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                ...
                                <div className="space-y-3">
                                    <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg p-3">
                                        ...
                                        <p className="text-blue-100 text-xs mt-1">Optimizes for distance only, may ignore resource constraints</p>
                                    </div>
                                                ...
                                                return (
                                                    <div
                                                        ...
                                                        className={`p-3 rounded-lg border-2 transition-all hover:shadow-md ${
                                                            node.status === 'critical' ? 'bg-red-50 border-red-400' :
                                                    ...
                                                    >
                                                        <div className="flex items-start justify-between mb-2">
                                                            ...
                                                            <span className={`px-2 py-0.5 rounded text-xs font-bold ${
                                                                node.status === 'critical' ? 'bg-red-200 text-red-800' :
                                                        ...
                                                        <div className="grid grid-cols-2 gap-2 text-xs">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className={`font-bold ${
                                                                    hasHighPacketLoss ? 'text-red-600' :
                                ...
                                <div className="space-y-3">
                                    <div className="bg-gradient-to-r from-orange-600 to-orange-700 rounded-lg p-3">
                                        <h4 className="text-white font-bold text-sm uppercase tracking-wide flex items-center gap-2">
                                            <span>🟠</span>
                                        ...
                                        <p className="text-orange-100 text-xs mt-1">Balances distance and resource utilization for optimal performance</p>
                                    </div>
